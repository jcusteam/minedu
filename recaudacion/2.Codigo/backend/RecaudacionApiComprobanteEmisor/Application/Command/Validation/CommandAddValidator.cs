...
namespace RecaudacionApiComprobanteEmisor.Application.Command.Validation
{
    ...
    public class GeneralAddValidator : AbstractValidator<CommandAdd>
    {
        public GeneralAddValidator()
        {
    ...
    public class CommandAddValidator : AbstractValidator<CommandAdd>
    {
        private readonly IUnidadEjecutoraAPI _unidadEjecutoraAPI;
        public CommandAddValidator(IUnidadEjecutoraAPI unidadEjecutoraAPI)
        {
            _unidadEjecutoraAPI = unidadEjecutoraAPI;

            Include(new GeneralAddValidator());
            ...
            RuleFor(x => x.FormDto.UsuarioCreador)
                ...
                .MaximumLength(ComprobanteEmisorConsts.UsuarioCreadorMaxLength)
                .WithMessage($"La longitud del Usuario Creador debe tener {ComprobanteEmisorConsts.UsuarioCreadorMaxLength} caracteres o menos");
