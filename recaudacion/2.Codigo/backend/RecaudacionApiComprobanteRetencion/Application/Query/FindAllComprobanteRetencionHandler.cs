...
{
    public class FindAllComprobanteRetencionHandler
    {
        ...
        public class Handler : IRequestHandler<Query, StatusFindAllResponse>
        {
            ...
            public Handler(IComprobanteRetencionRepository repository, IMapper mapper)
            {
                _mapper = mapper;
            ...
            public async Task<StatusFindAllResponse> Handle(Query request, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    response.Data = _mapper.Map<List<ComprobanteRetencionDto>>(items);
