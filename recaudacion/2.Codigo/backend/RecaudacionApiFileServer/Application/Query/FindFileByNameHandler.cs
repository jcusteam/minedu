...
{
    public class FindFileByNameHandler
    {
        ...
        public class Handler : IRequestHandler<Query, StatusFindFileResponse>
        {
            ...
            public async Task<StatusFindFileResponse> Handle(Query request, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    {
                        response.Messages.Add(new GenericMessage(Definition.MESSAGE_TYPE_ERROR, "subDirectory no es válido"));
                    ...
                    {
                        response.Messages.Add(new GenericMessage(Definition.MESSAGE_TYPE_ERROR, "FileName no es válido"));
                        response.Success = false;
                        return response;
                    }
                    ...
                    response.Data = fileReponse.Data;
