...
namespace RecaudacionApiOseSunat.Helpers
{
    public class FacturaPDF
    {
        public void GenerarPDF(string filename, string pathServer, Documento clsObj, AppSettings appSettings)
        {
            ...
            itextUtil.iTexto(document, writer, 115, 21, 82, 6, 0, textAlignmentCenter, "HELVETICA", 12, "Bold", "Normal", "BlacK", "FACTURA ELECTRONICA");
            ...
            itextUtil.iTexto(document, writer, 15, 55, 18, 6, 0, textAlignmentRight, "HELVETICA", 7, "Normal", "Normal", "BlacK", "RUC");
            ...
            itextUtil.iTexto(document, writer, 158, 69, 24, 6, 0, textAlignmentLeft, "HELVETICA", 7, "Normal", "Normal", "BlacK", clsObj.OrdenCompra);
            ...
            itextUtil.iTexto(document, writer, 115, 80, 30, 3, 0, textAlignmentLeft, "HELVETICA", 6, "Bold", "Normal", "BlacK", " UM.");
            ...
            itextUtil.iTexto(document, writer, 160, 80, 17, 3, 0, textAlignmentRight, "HELVETICA", 6, "Bold", "Normal", "BlacK", "DESCUENTO");
            ...
            foreach (DocumentoDetalle item in clsObj.DetalleDocumento)
            {
                ...
                p = itextUtil.iTexto(document, writer, 17, y, 92, 6, 0, textAlignmentLeft, "HELVETICA", 6, "Normal", "Normal", "BlacK", descripcion);
                ...
                y = y + (6 * p);//3 = espacio de alto que ocupa la fuente de acuerdo al tamaño es muy importante el tamaño de la fuente
            }
            ...
            itextUtil.iTexto(document, writer, 13, 225, 160, 4, 0, textAlignmentLeft, "HELVETICA", 9, "Normal", "Normal", "BlacK", "Representación de la FACTURA ELECTRONICA");
