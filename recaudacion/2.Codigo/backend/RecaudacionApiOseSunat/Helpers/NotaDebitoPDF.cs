...
namespace RecaudacionApiOseSunat.Helpers
{
    public class NotaDebitoPDF
    {
        public void GenerarPDF(string filename, string pathServer, Documento clsObj, AppSettings appSettings)
        {
            ...
            itextUtil.iTexto(document, writer, 115, 21, 82, 6, 0, textAlignmentCenter, "HELVETICA", 12, "Bold", "Normal", "BlacK", "NOTA DEBITO ELECTRONICA");
            ...
            string fechatmp = Convert.ToDateTime(clsObj.FechaEmision).Day + " de " + NombreMes(Convert.ToDateTime(clsObj.FechaEmision).Month) + " del " + Convert.ToDateTime(clsObj.FechaEmision).Year;

            //x, y, w, h
            //x(derecha),y,w,alto

            itextUtil.iTexto(document, writer, 11, 51, 28, 2, 0, textAlignmentLeft, "HELVETICA", 8, "Normal", "Normal", "BlacK", "Señor(es) :");
            itextUtil.iTexto(document, writer, 11, 56, 28, 2, 0, textAlignmentLeft, "HELVETICA", 8, "Normal", "Normal", "BlacK", "Dirección :");
            itextUtil.iTexto(document, writer, 11, 61, 28, 2, 0, textAlignmentLeft, "HELVETICA", 8, "Normal", "Normal", "BlacK", "N° de documento :");
            itextUtil.iTexto(document, writer, 11, 66, 28, 2, 0, textAlignmentLeft, "HELVETICA", 8, "Normal", "Normal", "BlacK", "Fecha de Emisión :");
            itextUtil.iTexto(document, writer, 11, 71, 28, 2, 0, textAlignmentLeft, "HELVETICA", 8, "Normal", "Normal", "BlacK", "Motivo de la Emisión :");
            ...
            itextUtil.iTexto(document, writer, 136, 56, 34, 2, 0, textAlignmentLeft, "HELVETICA", 8, "Normal", "Normal", "BlacK", "Documento que modifica : ");
            itextUtil.iTexto(document, writer, 136, 61, 34, 2, 0, textAlignmentLeft, "HELVETICA", 8, "Normal", "Normal", "BlacK", "Denominación :");
            ...
            itextUtil.iTexto(document, writer, 13, 225, 160, 4, 0, textAlignmentLeft, "HELVETICA", 9, "Normal", "Normal", "BlacK", "Representación de la NOTA DE DEBITO ELECTRONICA");
