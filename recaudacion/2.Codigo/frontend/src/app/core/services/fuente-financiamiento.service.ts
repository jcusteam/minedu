...
} from "../models/fuentefinanciamiento";
...
export class FuenteFinanciamientoService {
  API_URL = environment.url.apiGateway + environment.url.apiEndPoints.suiteKong + environment.url.apiEndPoints.fuenteFinanciamiento;

  constructor(private http: HttpClient) { }

  getFuenteFinanciamientosFilter(
    filter: FuenteFinanciamientoFilter
  ): Observable<IStatusResponse<IPagination<FuenteFinanciamiento>>> {
  ...
  getFuenteFinanciamientos() {
    ...
    return this.http
      .get<IStatusResponse<FuenteFinanciamiento[]>>(`${this.API_URL}`, {
        headers,
      })
      .pipe(
        map((response: IStatusResponse<any>) => {
  ...
  getFuenteFinanciamientoById(id: number) {
    let datehex = Tools.decimalToHexDate();
    let authToken = {
      token: CryptoAes.encryptStringAES256(datehex),
    };
    ...
    return this.http
      .get<IStatusResponse<FuenteFinanciamiento>>(`${this.API_URL}/` + id, {
        headers,
      })
      .pipe(
        map((response: IStatusResponse<any>) => {
  ...
  createFuenteFinanciamiento(fuenteFinanciamiento: FuenteFinanciamiento) {
    let datehex = Tools.decimalToHexDate();
    let authToken = {
      token: CryptoAes.encryptStringAES256(datehex),
    };
    ...
    let form = {
      data: CryptoAes.encryptAES256(fuenteFinanciamiento),
    };
    return this.http
      .post<IStatusResponse<FuenteFinanciamiento>>(this.API_URL, form, {
        headers,
      })
      .pipe(
        map((response: IStatusResponse<any>) => {
  ...
  updateFuenteFinanciamiento(fuenteFinanciamiento: FuenteFinanciamiento) {
    let datehex = Tools.decimalToHexDate();
    let authToken = {
      token: CryptoAes.encryptStringAES256(datehex),
    };
    ...
    return this.http
      .put<IStatusResponse<any>>(
        `${this.API_URL}/` + fuenteFinanciamiento.fuenteFinanciamientoId,
        form,
        { headers }
      )
      .pipe(
  ...
  deleteFuenteFinanciamiento(id: number) {
    let datehex = Tools.decimalToHexDate();
    let authToken = {
      token: CryptoAes.encryptStringAES256(datehex),
    };
