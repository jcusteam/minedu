...
@Component({
  selector: 'app-edit-uit',
  templateUrl: './edit-uit.component.html',
  styleUrls: ['./edit-uit.component.scss']
})
export class EditUitComponent implements OnInit {
  form: FormGroup;
  periodoUitEnum = PeriodoUitEnum;
  periodoMin = this.periodoUitEnum.ANIO_INICIO;
  periodoMax = new Date().getFullYear();
  constructor(
    public dialogRef: MatDialogRef<EditUitComponent>,
