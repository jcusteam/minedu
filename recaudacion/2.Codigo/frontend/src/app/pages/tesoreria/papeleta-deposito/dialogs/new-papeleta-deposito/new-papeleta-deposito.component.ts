...
@Component({
  selector: "app-new-papeleta-deposito",
  templateUrl: "./new-papeleta-deposito.component.html",
  styleUrls: ["./new-papeleta-deposito.component.scss"],
  providers: [
    { provide: DatePipe },
...
export class NewPapeletaDepositoComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<NewPapeletaDepositoComponent>,
