...
import { ListSaldoIngresoBoletaComponent } from "../list-saldo-ingreso/list-saldo-ingreso.component";
import { NewBoletaClienteComponent } from "../new-boleta-cliente/new-boleta-cliente.component";
...
@Component({
  ...
  styleUrls: ["./new-boleta.component.scss"],
  providers: [
    { provide: DatePipe },
...
export class NewBoletaComponent implements OnInit {
  ...
  // Constructor
  constructor(
    public dialogRef: MatDialogRef<NewBoletaComponent>,
  ...
  openDialogCatalogoBien() {
    ...
    const dialogRef = this.dialog.open(ListSaldoIngresoBoletaComponent, {
      width: "1000px",
      disableClose: true,
      data: catalogoBien,
    });
  ...
  onSubmit(form: ComprobantePago) {
    ...
    if (this.dataSource.data.length == 0) {
      this.messageService.msgWarning("Ingrese el detalle de la Boleta de Venta", () => { });
      return;
    }
  ...
  openDialogNewCliente() {
    ...
    const dialogRef = this.dialog.open(NewBoletaClienteComponent, {
      width: "800px",
      disableClose: true,
      data: cliente,
    });
