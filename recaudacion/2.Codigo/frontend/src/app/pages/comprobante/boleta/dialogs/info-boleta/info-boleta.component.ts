...
@Component({
  selector: 'app-info-boleta',
  templateUrl: './info-boleta.component.html',
  styleUrls: ['./info-boleta.component.scss'],
  providers: [
    { provide: DatePipe },
...
export class InfoBoletaComponent implements OnInit {
  ...
  // Constructor
  constructor(
    public dialogRef: MatDialogRef<InfoBoletaComponent>,
