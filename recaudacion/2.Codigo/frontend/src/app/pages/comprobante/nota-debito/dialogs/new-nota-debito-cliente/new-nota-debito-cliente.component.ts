...
@Component({
  selector: 'app-new-nota-debito-cliente',
  templateUrl: './new-nota-debito-cliente.component.html',
  styleUrls: ['./new-nota-debito-cliente.component.scss']
})
export class NewNotaDebitoClienteComponent implements OnInit {
  //Enums
  ...
  constructor(
    public dialogRef: MatDialogRef<NewNotaDebitoClienteComponent>,
