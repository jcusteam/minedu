...
@Component({
  selector: 'app-info-nota-debito',
  templateUrl: './info-nota-debito.component.html',
  styleUrls: ['./info-nota-debito.component.scss'],
  providers: [
    { provide: DatePipe },
...
export class InfoNotaDebitoComponent implements OnInit {
  // Enums
  ...
  // Constructor
  constructor(
    public dialogRef: MatDialogRef<InfoNotaDebitoComponent>,
