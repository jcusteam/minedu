...
@Component({
  selector: 'app-new-factura-cliente',
  templateUrl: './new-factura-cliente.component.html',
  styleUrls: ['./new-factura-cliente.component.scss']
})
export class NewFacturaClienteComponent implements OnInit {
  //Enums
  ...
  constructor(
    public dialogRef: MatDialogRef<NewFacturaClienteComponent>,
