...
import { ComprobantePago, ComprobantePagoDetalle } from 'src/app/core/models/comprobantepago';
...
@Component({
  selector: 'app-info-nota-credito',
  templateUrl: './info-nota-credito.component.html',
  styleUrls: ['./info-nota-credito.component.scss'],
  providers: [
    { provide: DatePipe },
...
export class InfoNotaCreditoComponent implements OnInit {
  ...
  // Constructor
  constructor(
    public dialogRef: MatDialogRef<InfoNotaCreditoComponent>,
  ...
  ngOnInit() {
    ...
    if (this.data?.fuenteValidar == this.fuenteValidaEnum.SI) {
      this.form.patchValue({ documentoFuenteValida: true });
    }
  }
