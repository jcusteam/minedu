...
@Component({
  selector: 'app-new-nota-credito-cliente',
  templateUrl: './new-nota-credito-cliente.component.html',
  styleUrls: ['./new-nota-credito-cliente.component.scss']
})
export class NewNotaCreditoClienteComponent implements OnInit {
  //Enums
  ...
  constructor(
    public dialogRef: MatDialogRef<NewNotaCreditoClienteComponent>,
